...
- (void)layoutSubviews
{
    ...
    // Start centered
    CGRect realframe = CGRectMake((self.bounds.size.width - realsize.width) / 2,
                                  (self.bounds.size.height - realsize.height) / 2,
                                  realsize.width,
                                  realsize.height);
    ...
    if (nil != self.superview.superview.superview)
    {
        CGPoint center = self.superview.superview.superview.center;
        CGPoint pnt = CGPointMake(center.x, center.y - 32);
        _realImageView.center = pnt;
    }
